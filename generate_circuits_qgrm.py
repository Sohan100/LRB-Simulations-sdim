"""Generate all QGRM-code RB/LRB circuits for a new run folder."""
...
class QGRMCircuitGenerationScript:
    """
    CLI helper for QGRM-code circuit generation.
    ...
    def build_arg_parser(cls) -> argparse.ArgumentParser:
        ...
        parser = argparse.ArgumentParser(
            description="Generate QGRM-code RB/LRB circuits."
        )
    ...
    def main(cls) -> None:
        """
        Parse CLI arguments and execute QGRM-code setup generation.
...
if __name__ == "__main__":
    QGRMCircuitGenerationScript.main()
